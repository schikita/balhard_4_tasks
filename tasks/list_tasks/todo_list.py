...
add_by_index(todo_list, 1, 'Приготовить поесть') -> ['Купить продукты', 'Приготовить поесть',
'Вынести мусор']
add_by_index(todo_list, 0, 'Сделать зарядку') -> ['Сделать зарядку', 'Купить продукты',
'Приготовить поесть', 'Вынести мусор']
"""
todo_list = []
